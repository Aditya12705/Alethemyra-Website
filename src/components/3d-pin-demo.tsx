  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center w-full gap-6 md:gap-8 py-6 md:py-10">
      ...
      <PinContainer
        ...
        className="border-0"
      >
        <div className="flex basis-full flex-col p-3 md:p-4 tracking-tight sm:basis-1/2 w-[15rem] h-[15rem] md:w-[20rem] md:h-[20rem] bg-[#7C6A4E] rounded-2xl items-center justify-center text-center shadow-md">
          <h3
            className="max-w-xs !pb-2 !m-0 font-bold text-xl md:text-3xl"
            style={{ color: "#F4F4F2" }}
          >
            {userTitle}
          </h3>
          <div className="text-base md:text-xl !m-0 !p-0 font-semibold mt-2" style={{ color: "#F4F4F2" }}>
            {userDescription}
          </div>
