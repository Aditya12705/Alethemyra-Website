    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            key={idx}
            className="relative min-w-[250px] max-w-xs md:min-w-[400px] md:max-w-[400px] rounded-2xl border border-[#C2A66C] bg-[#F4F4F2] px-4 md:px-8 py-6 flex flex-col justify-between"
          >
